...
# output v.1
output = attendance[['mp_id', 'given_name', 'family_name', 'name', 'photo_url', 'list', 'attendance', 'possible', 'rate', 'in_parliament']]
...
# save all
output.to_csv(data_path + "attendance.v1.all.csv", index=False)

# only current mps
output = output[output['in_parliament']]
